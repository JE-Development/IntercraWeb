          ...
          <div class="absolute">
            <div class="scroll-down">
                <div>
                    ...
                    <VueScriptComponent :script="adsScript" />
...
document.write('<scr' + 'ipt type="text/javascript" src="http' + (location.protocol === 'https:' ? 's' : '') + '://caresspincers.com/a07474aa74bd2f07f728638a5395d920/invoke.js"></scr' + 'ipt>');
</scr`+`ipt>
`
        }
    },
